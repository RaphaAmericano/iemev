...
idAtendenteDeCadastramento  INTEGER NOT NULL,
...
cpfCliente		bigint (11) PRIMARY KEY,
...
idAnimal		integer NOT NULL,
idAtendenteAbriuFicha	INTEGER NOT NULL,
idAtendenteFechouFicha	INTEGER NOT NULL DEFAULT 0,
...
idInternacao		INTEGERS PRIMARY KEY,
dataInternacao		date NOT NULL,
numeroFicha		INTEGER NOT NULL,
numeroBox		INTEGER NOT NULL,
cpfVeterinario			 bigint (11) NOT NULL,
...
idEmpregadoDeOrdenacao	INTEGER NOT NULL,
...
idAdministradorDeCadastramento  INTEGER NOT NULL,
FOREIGN KEY (idAdministradorDeCadastramento) REFERENCES T_EMPREGADO (idEmpregado) ON UPDATE CASCADE
);

DROP TABLE IF EXISTS T_VETERINARIO;
CREATE TABLE T_VETERINARIO (
cpfVeterinario		bigint (11) PRIMARY KEY,
crmv			decimal(8) NOT NULL,
especialidade		text NOT NULL,
FOREIGN KEY (cpfVeterinario) REFERENCES T_PESSOA (cpf) ON UPDATE CASCADE
);